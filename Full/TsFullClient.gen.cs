...
partial class TsFullClient
{
	...
	partial void ProcessEachBanList(BanList notify);
	partial void ProcessChannelChanged(ChannelChanged[] notifies);
	partial void ProcessEachChannelChanged(ChannelChanged notify);
	partial void ProcessChannelClientPermList(ChannelClientPermList[] notifies);
	partial void ProcessEachChannelClientPermList(ChannelClientPermList notify);
	partial void ProcessChannelCreated(ChannelCreated[] notifies);
	partial void ProcessEachChannelCreated(ChannelCreated notify);
	partial void ProcessChannelDeleted(ChannelDeleted[] notifies);
	partial void ProcessEachChannelDeleted(ChannelDeleted notify);
	partial void ProcessChannelDescriptionChanged(ChannelDescriptionChanged[] notifies);
	partial void ProcessEachChannelDescriptionChanged(ChannelDescriptionChanged notify);
	partial void ProcessChannelEdited(ChannelEdited[] notifies);
	partial void ProcessEachChannelEdited(ChannelEdited notify);
	partial void ProcessChannelEditedLow(ChannelEditedLow[] notifies);
	partial void ProcessEachChannelEditedLow(ChannelEditedLow notify);
	partial void ProcessChannelGroupClientList(ChannelGroupClientList[] notifies);
	partial void ProcessEachChannelGroupClientList(ChannelGroupClientList notify);
	partial void ProcessChannelGroupList(ChannelGroupList[] notifies);
	partial void ProcessEachChannelGroupList(ChannelGroupList notify);
	partial void ProcessChannelGroupPermList(ChannelGroupPermList[] notifies);
	partial void ProcessEachChannelGroupPermList(ChannelGroupPermList notify);
	partial void ProcessChannelList(ChannelList[] notifies);
	partial void ProcessEachChannelList(ChannelList notify);
	partial void ProcessChannelListFinished(ChannelListFinished[] notifies);
	partial void ProcessEachChannelListFinished(ChannelListFinished notify);
	partial void ProcessChannelMoved(ChannelMoved[] notifies);
	partial void ProcessEachChannelMoved(ChannelMoved notify);
	partial void ProcessChannelPasswordChanged(ChannelPasswordChanged[] notifies);
	partial void ProcessEachChannelPasswordChanged(ChannelPasswordChanged notify);
	partial void ProcessChannelPermissionHints(ChannelPermissionHints[] notifies);
	partial void ProcessEachChannelPermissionHints(ChannelPermissionHints notify);
	partial void ProcessChannelPermList(ChannelPermList[] notifies);
	partial void ProcessEachChannelPermList(ChannelPermList notify);
	partial void ProcessChannelSubscribed(ChannelSubscribed[] notifies);
	partial void ProcessEachChannelSubscribed(ChannelSubscribed notify);
	partial void ProcessChannelUnsubscribed(ChannelUnsubscribed[] notifies);
	partial void ProcessEachChannelUnsubscribed(ChannelUnsubscribed notify);
	partial void ProcessClientChannelGroupChanged(ClientChannelGroupChanged[] notifies);
	partial void ProcessEachClientChannelGroupChanged(ClientChannelGroupChanged notify);
	partial void ProcessClientChatClosed(ClientChatClosed[] notifies);
	partial void ProcessEachClientChatClosed(ClientChatClosed notify);
	partial void ProcessClientChatComposing(ClientChatComposing[] notifies);
	partial void ProcessEachClientChatComposing(ClientChatComposing notify);
	partial void ProcessClientConnectionInfo(ClientConnectionInfo[] notifies);
	partial void ProcessEachClientConnectionInfo(ClientConnectionInfo notify);
	partial void ProcessClientConnectionInfoUpdateRequest(ClientConnectionInfoUpdateRequest[] notifies);
	partial void ProcessEachClientConnectionInfoUpdateRequest(ClientConnectionInfoUpdateRequest notify);
	partial void ProcessClientDbFind(ClientDbFind[] notifies);
	partial void ProcessEachClientDbFind(ClientDbFind notify);
	partial void ProcessClientDbIdFromUid(ClientDbIdFromUid[] notifies);
	partial void ProcessEachClientDbIdFromUid(ClientDbIdFromUid notify);
	partial void ProcessClientDbList(ClientDbList[] notifies);
	partial void ProcessEachClientDbList(ClientDbList notify);
	partial void ProcessClientEnterView(ClientEnterView[] notifies);
	partial void ProcessEachClientEnterView(ClientEnterView notify);
	partial void ProcessClientIds(ClientIds[] notifies);
	partial void ProcessEachClientIds(ClientIds notify);
	...
	partial void ProcessEachClientMoved(ClientMoved notify);
	partial void ProcessClientNameFromDbId(ClientNameFromDbId[] notifies);
	partial void ProcessEachClientNameFromDbId(ClientNameFromDbId notify);
	partial void ProcessClientNameFromUid(ClientNameFromUid[] notifies);
	partial void ProcessEachClientNameFromUid(ClientNameFromUid notify);
	partial void ProcessClientNeededPermissions(ClientNeededPermissions[] notifies);
	partial void ProcessEachClientNeededPermissions(ClientNeededPermissions notify);
	partial void ProcessClientPermissionHints(ClientPermissionHints[] notifies);
	partial void ProcessEachClientPermissionHints(ClientPermissionHints notify);
	partial void ProcessClientPermList(ClientPermList[] notifies);
	partial void ProcessEachClientPermList(ClientPermList notify);
	partial void ProcessClientPoke(ClientPoke[] notifies);
	partial void ProcessEachClientPoke(ClientPoke notify);
	partial void ProcessClientServerGroupAdded(ClientServerGroupAdded[] notifies);
	partial void ProcessEachClientServerGroupAdded(ClientServerGroupAdded notify);
	partial void ProcessClientServerGroupRemoved(ClientServerGroupRemoved[] notifies);
	partial void ProcessEachClientServerGroupRemoved(ClientServerGroupRemoved notify);
	partial void ProcessClientSetServerQueryLogin(ClientSetServerQueryLogin[] notifies);
	partial void ProcessEachClientSetServerQueryLogin(ClientSetServerQueryLogin notify);
	partial void ProcessClientUidFromClid(ClientUidFromClid[] notifies);
	partial void ProcessEachClientUidFromClid(ClientUidFromClid notify);
	partial void ProcessClientUpdated(ClientUpdated[] notifies);
	partial void ProcessEachClientUpdated(ClientUpdated notify);
	...
	partial void ProcessEachComplainList(ComplainList notify);
	partial void ProcessFileDownload(FileDownload[] notifies);
	partial void ProcessEachFileDownload(FileDownload notify);
	partial void ProcessFileInfo(FileInfo[] notifies);
	partial void ProcessEachFileInfo(FileInfo notify);
	partial void ProcessFileList(FileList[] notifies);
	partial void ProcessEachFileList(FileList notify);
	partial void ProcessFileListFinished(FileListFinished[] notifies);
	partial void ProcessEachFileListFinished(FileListFinished notify);
	partial void ProcessFiletransfer(Filetransfer[] notifies);
	partial void ProcessEachFiletransfer(Filetransfer notify);
	partial void ProcessFiletransferStatus(FiletransferStatus[] notifies);
	partial void ProcessEachFiletransferStatus(FiletransferStatus notify);
	partial void ProcessFileUpload(FileUpload[] notifies);
	partial void ProcessEachFileUpload(FileUpload notify);
	partial void ProcessInitIvExpand(InitIvExpand[] notifies);
	partial void ProcessEachInitIvExpand(InitIvExpand notify);
	partial void ProcessInitIvExpand2(InitIvExpand2[] notifies);
	partial void ProcessEachInitIvExpand2(InitIvExpand2 notify);
	...
	partial void ProcessEachOfflineMessage(OfflineMessage notify);
	partial void ProcessOfflineMessageList(OfflineMessageList[] notifies);
	partial void ProcessEachOfflineMessageList(OfflineMessageList notify);
	partial void ProcessPermFind(PermFind[] notifies);
	partial void ProcessEachPermFind(PermFind notify);
	partial void ProcessPermList(PermList[] notifies);
	partial void ProcessEachPermList(PermList notify);
	partial void ProcessPermOverview(PermOverview[] notifies);
	partial void ProcessEachPermOverview(PermOverview notify);
	partial void ProcessPluginCommand(PluginCommand[] notifies);
	partial void ProcessEachPluginCommand(PluginCommand notify);
	partial void ProcessServerConnectionInfo(ServerConnectionInfo[] notifies);
	partial void ProcessEachServerConnectionInfo(ServerConnectionInfo notify);
	partial void ProcessServerEdited(ServerEdited[] notifies);
	partial void ProcessEachServerEdited(ServerEdited notify);
	partial void ProcessServerGroupClientList(ServerGroupClientList[] notifies);
	partial void ProcessEachServerGroupClientList(ServerGroupClientList notify);
	partial void ProcessServerGroupList(ServerGroupList[] notifies);
	partial void ProcessEachServerGroupList(ServerGroupList notify);
	partial void ProcessServerGroupPermList(ServerGroupPermList[] notifies);
	partial void ProcessEachServerGroupPermList(ServerGroupPermList notify);
	partial void ProcessServerGroupsByClientId(ServerGroupsByClientId[] notifies);
	partial void ProcessEachServerGroupsByClientId(ServerGroupsByClientId notify);
	partial void ProcessServerLog(ServerLog[] notifies);
	partial void ProcessEachServerLog(ServerLog notify);
	partial void ProcessServerTempPasswordList(ServerTempPasswordList[] notifies);
	partial void ProcessEachServerTempPasswordList(ServerTempPasswordList notify);
	partial void ProcessServerUpdated(ServerUpdated[] notifies);
	partial void ProcessEachServerUpdated(ServerUpdated notify);
	partial void ProcessTextMessage(TextMessage[] notifies);
	partial void ProcessEachTextMessage(TextMessage notify);
	partial void ProcessTokenAdd(TokenAdd[] notifies);
	partial void ProcessEachTokenAdd(TokenAdd notify);
	partial void ProcessTokenList(TokenList[] notifies);
	partial void ProcessEachTokenList(TokenList notify);
	partial void ProcessTokenUsed(TokenUsed[] notifies);
	partial void ProcessEachTokenUsed(TokenUsed notify);
}
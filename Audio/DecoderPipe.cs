        ...
        public void Write(Span<byte> data, Meta? meta) {
            ...
            switch (meta.Codec.Value) {
                case Codec.OpusVoice: {
                    ...
                    var decodedData = decoder.Decode(data, meta.In.Seq, decodedBuffer.AsSpan(0, decodedBuffer.Length / 2));
                ...
                case Codec.OpusMusic: {
                    ...
                    var decodedData = decoder.Decode(data, meta.In.Seq, decodedBuffer);
